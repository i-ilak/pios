...
enum
{
    ...
    GPSET0
    = (GPIO_BASE
       + 0x1C), /**< The GPSET0 register is used to set GPIO pins 0-31 */
    GPSET1
    = (GPIO_BASE
       + 0x20), /**< The GPSET1 register is used to set GPIO pins 32-53 */
    ...
    GPCLR0
    = (GPIO_BASE
       + 0x28), /**< The GPCLR0 register is used to clear GPIO pins 0-31 */
    GPCLR1
    = (GPIO_BASE
       + 0x2C), /**< The GPCLR1 register is used to clear GPIO pins 32-53 */
     ...
     */
    GPPUDCLK0
    = (GPIO_BASE + 0x98), /**< GPIO Pin Pull-up/down Enable Clocks 0 */
    GPPUDCLK1
    = (GPIO_BASE + 0x9C) /**< GPIO Pin Pull-up/down Enable Clocks 1 */
    ...
    = (GPIO_BASE + 0xE4), /**< GPIO Pull-up / Pull-down Registers 0 */
    GPIO_PUP_PDN_CNTRL_REG1
    = (GPIO_BASE + 0xE8), /**< GPIO Pull-up / Pull-down Registers 1 */
    GPIO_PUP_PDN_CNTRL_REG2
    = (GPIO_BASE + 0xEC), /**< GPIO Pull-up / Pull-down Registers 2 */
    GPIO_PUP_PDN_CNTRL_REG3
    = (GPIO_BASE + 0xF0) /**< GPIO Pull-up / Pull-down Registers 3 */
#endif
};
