 ...
 * SPI  masters. > These three  peripheral  are  grouped  together  as  they
 * share  the same  area  in  the  peripheral register map and they share a
 * common interrupt. > Also all three are controlled by the auxiliary enable
 * register.
 */
...
/**
 * @brief Enum containg all the relevant addresses. The offset is again the
 * same for all RPi's, but the base address is not.
 */
enum
{
