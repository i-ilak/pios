...
/**
 * @brief Calculates the length of the string pointed to by @a s, excluding the
...
/**
 * @brief Copies the string pointed to by @a src, including the terminating
 * null byte ('\0'), to the buffer pointed to by @a dest.
...
/**
 * @brief Appends the @a src string to the @a dest string, overwriting the
 * terminating null byte ('\0') at the end of @a dest, and then adds a
